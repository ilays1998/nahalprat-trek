...
class Config:
    ...
    # Use Render's PORT env var if available, otherwise use BACKEND_PORT, fallback to 5000
    BACKEND_PORT = int(os.environ.get("PORT") or os.environ.get("BACKEND_PORT", "5000"))
